 ...
 **/
public class JavaFxMainRectangle extends Application {
    ...
    public void start(Stage stage) {
        ...
        FillTransition green = new FillTransition(Duration.millis(325));
        green.setToValue(Color.GREEN);
        FillTransition red = new FillTransition(Duration.millis(325));
        red.setToValue(Color.RED);
        ...
        ParallelTransition transition = new ParallelTransition(r,
                translate, green, red, rotate, scale);
